...
public class MaskingTest {
    ...
    static class UserDto {
        ...
        public UserDto(String name, String email, String creditCard, String rrn, String brn, String unmasked) {
            this.name = name;
            this.email = email;
    ...
    void testMaskingEngine() {
        ...
        UserDto user = new UserDto("Alice", "alice@example.com", "1234-5678-1234-5678", "850209-1234567",
                "123-45-67890", "visible");
