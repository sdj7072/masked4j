 ...
 *
 * <p>This class uses the {@link MaskType} enum to find the appropriate masker class and then
 * instantiates it. It ensures that maskers are instantiated efficiently.
 */
